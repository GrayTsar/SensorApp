 ...
 * [GeomagneticRotationVector.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [GeomagneticRotationVector.newInstance] factory method to
 * create an instance of this fragment.
 */
class GeomagneticRotationVector : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_geomagnetic_rotation_vector, container, false)

        sensorManager = context!!.getSystemService(Context.SENSOR_SERVICE) as SensorManager
        mSensor = sensorManager.getDefaultSensor(Sensor.TYPE_GEOMAGNETIC_ROTATION_VECTOR)
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorGeomagneticRotationVector) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_rotate_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorGreen, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorGreen, null))
        view.card.card_title.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorGeomagneticRotationVector)
        ...
        view.detail.sensor_text_max_range.text = "${getString(R.string.labelMaxRange)} ${mSensor.maximumRange}"
        view.detail.sensor_text_information.text = getString(R.string.infoGeomagneticRotationVector)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sEventListener = SensorSingleton.registerSelected(sensorManager, mSensor) {
            view.card_v1.text = String.format("%.2f", it.values[0])
            view.card_v2.text = String.format("%.2f", it.values[1])
            view.card_v3.text = String.format("%.2f", it.values[2])
    ...
    companion object {
         ...
         * @return A new instance of fragment GeomagneticRotationVector.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GeomagneticRotationVector().apply {
