 ...
 * [RelativeHumidity.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [RelativeHumidity.newInstance] factory method to
 * create an instance of this fragment.
 */
class RelativeHumidity : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_relative_humidity, container, false)
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorRelativeHumidity) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_humidity_white))

        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorTeal, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorTeal, null))
        view.card.card_title.visibility = TextView.GONE
        view.card_v2.visibility = TextView.GONE
        view.card_v3.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorRelativeHumidity)
        ...
        view.detail.sensor_text_information.text = getString(R.string.infoRelativeHumidity)
    ...
    companion object {
         ...
         * @return A new instance of fragment RelativeHumidity.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RelativeHumidity().apply {
