 ...
 * [Accelerometer.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Accelerometer.newInstance] factory method to
 * create an instance of this fragment.
 */
class Accelerometer : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorAccelerometer) + ".txt")
    ...
    companion object {
         ...
         * @return A new instance of fragment acceleration.
         */
