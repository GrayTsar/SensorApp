 ...
 * [Gravity.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Gravity.newInstance] factory method to
 * create an instance of this fragment.
 */
class Gravity : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorGravity) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_gravity_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorPurple, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorPurple, null))
        view.card.card_title.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorGravity)
        ...
        view.detail.sensor_text_information.text = getString(R.string.infoGravity)
    ...
    companion object {
         ...
         * @return A new instance of fragment Gravity.
         */
