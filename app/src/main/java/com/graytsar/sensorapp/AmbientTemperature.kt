 ...
 * [AmbientTemperature.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [AmbientTemperature.newInstance] factory method to
 * create an instance of this fragment.
 */
class AmbientTemperature : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ambient_temperature, container, false)
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorAmbientTemperature) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_temperature_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorBlue, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorBlue, null))
        view.card.card_title.visibility = TextView.GONE
        view.card_v2.visibility = TextView.GONE
        view.card_v3.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorAmbientTemperature)
        ...
        view.detail.sensor_text_max_range.text = "${getString(R.string.labelMaxRange)} ${mSensor.maximumRange} ${getString(R.string.unitTemperature)}"
        view.detail.sensor_text_information.text = getString(R.string.infoAmbientTemperature)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sEventListener = SensorSingleton.registerSelected(sensorManager, mSensor) {
            ...
            if(enableLog){
                bW.append("\n${it.timestamp},${it.values[0]}" as CharSequence)
                bW.flush()
            }
    ...
    companion object {
         ...
         * @return A new instance of fragment Ambient_Temperature.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AmbientTemperature().apply {
