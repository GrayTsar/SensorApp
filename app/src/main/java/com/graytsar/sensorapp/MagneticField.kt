 ...
 * [MagneticField.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [MagneticField.newInstance] factory method to
 * create an instance of this fragment.
 */
class MagneticField : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorMagneticField) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_magnet_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorPink, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorPink, null))
        view.card.card_title.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorMagneticField)
        ...
        view.detail.sensor_text_information.text = getString(R.string.infoMagneticField)
    ...
    companion object {
         ...
         * @return A new instance of fragment MagneticField.
         */
