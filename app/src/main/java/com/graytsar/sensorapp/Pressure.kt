 ...
 * [Pressure.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Pressure.newInstance] factory method to
 * create an instance of this fragment.
 */
class Pressure : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorPressure) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_pressure_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorCyan, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorCyan, null))
        view.card.card_title.visibility = TextView.GONE
        view.card_v2.visibility = TextView.GONE
        view.card_v3.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorPressure)
        ...
        view.detail.sensor_text_max_range.text = "${getString(R.string.labelMaxRange)} ${mSensor.maximumRange} ${getString(R.string.sensorPressure)}"
        view.detail.sensor_text_information.text = getString(R.string.infoPressure)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sEventListener = SensorSingleton.registerSelected(sensorManager, mSensor) {
            view.card_v1.text = String.format("%.2f", it.values[0]) + " ${getString(R.string.unitPressure)}"
