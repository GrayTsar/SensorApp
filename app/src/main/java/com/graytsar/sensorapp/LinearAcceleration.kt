 ...
 * [LinearAcceleration.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [LinearAcceleration.newInstance] factory method to
 * create an instance of this fragment.
 */
class LinearAcceleration : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_linear_acceleration, container, false)
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorLinearAcceleration) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_linearacceleration_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorIndigo, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorIndigo, null))
        view.card.card_title.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorLinearAcceleration)
        ...
        view.detail.sensor_text_information.text = getString(R.string.infoLinearAcceleration)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sEventListener = SensorSingleton.registerSelected(sensorManager, mSensor) {
            ...
            view.card_v1.text = String.format("%.2f", it.values[0]) + " $str"
            view.card_v2.text = String.format("%.2f", it.values[1]) + " $str"
    ...
    companion object {
         ...
         * @return A new instance of fragment LinearAcceleration.
         */
