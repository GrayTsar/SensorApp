 ...
 * [Light.OnFragmentInteractionListener] interface
...
class Light : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.card.floatingActionButton.setOnClickListener {
            ...
            if(enableLog){
                ...
                intent.putExtra(Intent.EXTRA_TITLE, getString(R.string.sensorLight) + ".txt")
                startActivityForResult(intent, 1)
            }
        }

        view.card.imageView.setImageDrawable(ContextCompat.getDrawable(view.context, R.drawable.ic_light_white))
        activity!!.toolbar.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorLightBlue, null))
        view.card.backView.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.colorLightBlue, null))
        view.card.card_title.visibility = TextView.GONE
        //view.card.card_title.text = getString(R.string.sensorLight)
        ...
        view.detail.sensor_text_max_range.text = "${getString(R.string.labelMaxRange)} ${mSensor.maximumRange} ${getString(R.string.unitLight)}"
        view.detail.sensor_text_information.text = getString(R.string.infoLight)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sEventListener = SensorSingleton.registerSelected(sensorManager, mSensor) {
            view.card_v1.text = String.format("%.2f", it.values[0]) + " ${getString(R.string.unitLight)}"
